        ...
        build: function() {
            ...
            KTUtil.addEvent(the.input, 'change', function(e) {
	            ...
	            if (the.input && the.input.files && the.input.files[0]) {
                    ...
                    {
                        _userProfileUrl = e.target.result;
...
var CQuickSearch = function () {
    ...
    var processSearch = function () {
        ...
        setTimeout(function () {
            $.ajax({
                url: '/api/CompanyApi/LoadCompany',
                data: {
                    name: query
                },
                dataType: 'json',
                success: function (res) {
                    ...
                    hideProgress();
                    KTUtil.addClass(target, resultClass);
                    KTUtil.setHTML(resultWrapper, data);
                    showDropdown();
                    KTUtil.scrollUpdate(resultWrapper);
                },
                error: function (res) {
...
var CCQuickSearch = CQuickSearch;
// Init on page load completed
...
KTUtil.ready(function() {
    ...
    if (KTUtil.get('kt_quick_search_inline')) {
        ...
        CCQuickSearch().init(KTUtil.get('kt_quick_search_inline'));
    }
