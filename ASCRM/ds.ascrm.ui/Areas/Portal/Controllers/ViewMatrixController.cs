...
{
    [Area("Portal")]
    [Route("Portal/ViewMatrix")]
    public class ViewMatrixController : BaseController
    {
        ...
        readonly ILogger<ViewMatrixController> _log;
        LogException LogException;
        //  private string _contact_us_url = string.Empty;
        private readonly IMemoryCache _cache;


        public ViewMatrixController(ILoginRepository loginRepository,
            IRoleAdminRepository roleAdminRepository,
            IMailService emailSender,
            IConfigurationRepository configurationRepository,
            IEmailTemplateRepository emailTemplateRepository,
            ILogger<ViewMatrixController> log,
